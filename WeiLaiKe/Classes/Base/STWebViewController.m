...
@interface STWebViewController () <WKNavigationDelegate,WKUIDelegate,WKScriptMessageHandler,UINavigationControllerDelegate,UINavigationBarDelegate>
...
- (void)viewWillAppear:(BOOL)animated{
    ...
    if (_isNavHidden == YES) {
        ...
        if (self.count != 0) {
            ...
            //设置成绿色
            statusBarView.backgroundColor=[UIColor st_backgroundColor];
            // 添加到 navigationBar 上
...
-(void)webView:(WKWebView *)webView didStartProvisionalNavigation:(WKNavigation *)navigation{
    ...
    if ([self.url isEqualToString:@"http://wfx.501533.com.cn/app/index.php?i=13&c=entry&do=shop&m=ewei_shop"] || [self.url isEqualToString:@"http://wfx.501533.com.cn/app/index.php?i=13&c=entry&do=member&m=ewei_shop"] || [self.url isEqualToString:@"http://wfx.501533.com.cn/app/index.php?i=13&c=entry&p=category&do=shop&m=ewei_shop"] || [self.url isEqualToString:@"http://wfx.501533.com.cn/app/index.php?i=13&c=entry&p=cart&do=shop&m=ewei_shop"]) {
...
//    [self.webView evaluateJavaScript:@"function(){var jq=document.createElement(\"script\");jq.setAttribute(\"src\",\"https://code.jquery.com/jquery-3.2.1.min.js\");document.getElementsByTagName(\"head\")[0].appendChild(jq);window.setTimeout(\"exec()\",1000)};function exec(){$('.cart_top'). removeClass('.cart_top')};" completionHandler:nil];
//    
//    [self.webView evaluateJavaScript:@"document.getElementById('goup').style.display='none'" completionHandler:^(id _Nullable response, NSError * _Nullable error) {
//        NSLog(@"response0: %@ error: %@", response, error);
//    }];
    

//    [self.webView evaluateJavaScript:@"document.getElementById('btn back').style.display='none'" completionHandler:nil];
}
